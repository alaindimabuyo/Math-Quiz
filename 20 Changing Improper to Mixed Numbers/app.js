...
// create questions
var questions = [
    new Question("Choose the correct numerator or denominator to make each item true", ["11", "12","13", "14"], "13"),
    new Question("Choose the correct numerator or denominator to make each item true", ["5", "10","14", "34"], "5"),
    new Question("Choose the correct numerator or denominator to make each item true", ["23", "4","8", "16"], "4"),
    new Question("Choose the correct numerator or denominator to make each item true", ["16", "15","14", "13"], "13"),
    new Question("Choose the correct numerator or denominator to make each item true", ["10", "11", "12", "13"], "11")
